...
- **Pinch-zoom bloqueado a propósito:** `Layout.astro:27` — viewport ahora con `maximum-scale=1.0, user-scalable=no`. Decisión consciente del usuario tras explicarle el trade-off (es anti-patrón de accesibilidad WCAG 1.4.4 y iOS Safari lo ignora desde hace años — funciona mejor en Android/Chrome, no es 100% confiable en iOS).
